...
public class DungeonStartTrigger extends Trigger {
    public DungeonStartTrigger() { super(); this.type = TriggerType.DUNGEON_START; }
    @Override
    ...
    protected TriggerResult doTrigger(Player player, Event event, DungeonInstance dungeonInstance, ExecutionContext context) {
        return TriggerResult.success("地牢开始触发", new HashMap<>());
    }
    @Override
