...
public class SignalReceivedTrigger extends Trigger {
    public SignalReceivedTrigger() { super(); this.type = TriggerType.SIGNAL_RECEIVED; }
    @Override
    ...
    protected TriggerResult doTrigger(Player player, Event event, DungeonInstance dungeonInstance, ExecutionContext context) {
        return TriggerResult.success("信号接收触发", new HashMap<>());
    }
    @Override
