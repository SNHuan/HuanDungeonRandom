...
public class DungeonEndTrigger extends Trigger {
    public DungeonEndTrigger() { super(); this.type = TriggerType.DUNGEON_END; }
    @Override
    ...
    protected TriggerResult doTrigger(Player player, Event event, DungeonInstance dungeonInstance, ExecutionContext context) {
        return TriggerResult.success("地牢结束触发", new HashMap<>());
    }
    @Override
